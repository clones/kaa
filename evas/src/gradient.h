/*
 * ----------------------------------------------------------------------------
 * gradient.h - evas gradient object wrapper
 * ----------------------------------------------------------------------------
 * $Id$
 *
 * ----------------------------------------------------------------------------
...
PyObject *Evas_Object_PyObject_gradient_color_stop_add(Evas_Object_PyObject *, PyObject *);
PyObject *Evas_Object_PyObject_gradient_clear(Evas_Object_PyObject *, PyObject *);
