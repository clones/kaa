...
import mmpython.audio.eyeD3.frames;
import mmpython.audio.eyeD3.mp3;
import mmpython.audio.eyeD3.tag;
from mmpython.audio.eyeD3.tag import *;
import mmpython.audio.eyeD3.utils;
