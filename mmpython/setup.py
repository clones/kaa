...
setup (# Distribution meta-data
       ...
       package_dir = {'mmpython.video': 'mmpython/video',
                      'mmpython.audio': 'mmpython/audio',
                      'mmpython.audio.eyeD3': 'mmpython/audio/eyeD3',
                      'mmpython.image': 'mmpython/image',
                      'mmpython.disc' : 'mmpython/disc',
                      'mmpython.misc' : 'mmpython/misc',
                      'mmpython': 'mmpython'},

       packages = [ 'mmpython', 'mmpython.video', 'mmpython.audio',
                    'mmpython.audio.eyeD3', 'mmpython.image',
                    'mmpython.disc', 'mmpython.misc' ],
